    ...
    def _get_column_name(self, variable: str, scale: str) -> str:
        ...
        if scale in ["hourly", "current"]:
            mapping = {
                ...
                "humidity": "rh_percent",
                "rh_mean_percent": "rh_percent",
                "wind_speed": "wind_speed_ms",
                "wind_speed_mean_ms": "wind_speed_ms",
                ...
                "visibility_mean_m": "visibility_m",
            ...
            mapping = {
                ...
                "rh_percent": "rh_mean_percent",
                "rh_mean_percent": "rh_mean_percent",
                "wind_speed": "wind_speed_mean_ms",
                "wind_speed_ms": "wind_speed_mean_ms",
                "wind_speed_mean_ms": "wind_speed_mean_ms",
                "wind_gust": "wind_speed_mean_ms",
                "wind_gusts": "wind_speed_mean_ms",
                "wind_gust_speed": "wind_speed_mean_ms",
                "wind_gust_ms": "wind_speed_mean_ms",
                "precipitation": "precipitation_sum_mm",
                "precipitation_mm": "precipitation_sum_mm",
                ...
                "visibility_m": "visibility_mean_m",
                "visibility_mean_m": "visibility_mean_m",
